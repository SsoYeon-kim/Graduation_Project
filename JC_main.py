...
# ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
    ...
    for face in faces:
            ...
            if blinking_ratio > 5:
                ...
                if blinking_frames == 5:
                    ...
                    if ch == "ㄱ ㄷ\nㄲ ㄸ":
                        ...
                        #tts 연결
                        URL = f'http://localhost:5000/tts-server/api/infer-glowtts?text={requests.utils.quote(result + ".")}'
        ...
        #자음 응시 창일 때 (4개 영역 중 한 영역 응시로 선택, 선택하면 momain으로)
            ...
            #오른쪽 위
            if gaze_ratio <= 0.9 and gaze_ratio_Top > 16.1:
                print("2번 자리 응시중")
                gaze_frame += 1
            ...
            # 오른쪽 아래
            elif gaze_ratio <= 0.9 and gaze_ratio_Top <= 16.1:
                print("4번 자리 응시중")
                gaze_frame += 1
